    ...
    <div className={`rounded-xl border ${toneMap[tone]} p-4`}>
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <div className="mt-2 text-2xl font-bold text-white mono">{value}</div>
        </div>
    ...
    <div className="p-6 space-y-6 max-w-[1500px] mx-auto">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Compact execution workspace for discretionary orders</p>
        </div>
