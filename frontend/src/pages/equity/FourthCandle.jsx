...
export default function FourthCandle() {
  ...
  const downloadCSV = () => {
    const cols = ['date', 'underlying', 'candles', 'fourth_high', 'fourth_low', 'breakout_time', 'entry_time', 'opt_type', 'symbol', 'strike', 'lot', 'qty', 'entry', 'target', 'sl', 'exit', 'exit_time', 'exit_reason', 'mtm', 'max_profit', 'max_loss', 'hold_days', 'hold_label', 'status', 'notes'];
